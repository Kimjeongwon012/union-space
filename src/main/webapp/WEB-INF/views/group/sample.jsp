...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="container">
		<div class="row gx-5">
		    <div class="col-3">장소 번호</div>
		    <div class="col-6">
				<div class="input-group mb-3">
				  <input type="text" id="No_input" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">	
				</div>
		    </div>
		    <div class="col-1">
		    </div>
